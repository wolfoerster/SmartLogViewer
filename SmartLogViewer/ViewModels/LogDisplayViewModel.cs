...
internal class LogDisplayViewModel : PropertyChangedNotifier
{
    private static readonly SmartLogger Log = new();
    private readonly LogDisplaySettings settings;

    public LogDisplayViewModel(LogDisplaySettings settings)
    {
        Log.Information();
